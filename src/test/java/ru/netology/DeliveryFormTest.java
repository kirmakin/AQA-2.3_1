...
public class DeliveryFormTest {
    ...
    void shouldResubmitRequest() {
        ...
        $("[data-test-id=date] [placeholder='Дата встречи']").setValue(DataGenerator.Registration.getDatePlus4());
        ...
        $("input[placeholder=\"Дата встречи\"]").sendKeys(DataGenerator.Registration.getDatePlus10());
        $(".grid-col .button__text").click();
